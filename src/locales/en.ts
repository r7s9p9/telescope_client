export const localeEN = {
  ...
  schema: {
    email: {
      ...
      TOO_LONG: (count: number) =>
        `Email must be less than ${count} characters`,
    },
    username: {
  ...
  authNotification: {
    ...
    REGISTER_SUCCESS:
      "You have successfully registered! Please sign in" as const,
  ...
  profile: {
    ...
    DETAILS_NOT_FOUND:
      "This profile does not exist or has been deleted" as const,
  ...
  topBar: {
    PUBLIC_TYPE: "Public" as const,
    PRIVATE_TYPE: "Private" as const,
    SINGLE_TYPE: "Single" as const,
  ...
  actions: {
    ...
    LEAVE_POPUP_TITLE: "Leave room" as const,
    ...
    DELETE_POPUP_TITLE: "Delete room" as const,
    DELETE_POPUP_QUESTION:
      "Are you sure you want to delete this room?" as const,
  ...
  actionsNotification: {
    ...
    COPY_SUCCESS: "Room link copied to clipboard" as const,
  },
  ...
  properties: {
    ...
    CREATOR_VALUE_YOU: "You" as const,
    CREATOR_VALUE_SERVICE: "Service" as const,
  ...
  settings: {
    ...
    LOGOUT_POPUP_TITLE: "Logout" as const,
  ...
  sessions: {
    ...
    DELETE_POPUP_TITLE: "Delete session" as const,
    DELETE_POPUP_QUESTION:
  ...
  language: {
    TITLE: "Select language" as const,
    OPTION_RU: "Russian" as const,
    OPTION_EN: "English" as const,
  },
